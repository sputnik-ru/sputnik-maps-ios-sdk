...
Pod::Spec.new do |s|
  ...
  # use command line option described below to lint this spec succesfully --sources='http://gitlab.srv.pv.km/ios-dev/cocoapods-spec.git,https://github.com/CocoaPods/Specs'
